...
transcribed).  Usage: PYTHONPATH=src python scripts/gen_yrep_module.py <i>   (i = 0..12)
"""
...
Generator : experiments/bb_lab/scripts/gen_yrep_module.py (arg: {i})
Regen     : cd experiments/bb_lab && uv run python scripts/gen_yrep_module.py {i}
...
`floorOK oL oR = true`.  Generated by `experiments/bb_lab/scripts/gen_yrep_module.py {i}`.
-/
...
'''
path = f"QEC/Stabilizer/Codes/BivariateBicycle/Gross/SafeFloor/MImFloorY{i}.lean"
