...
Reuses the validated a17_cover_ladder machinery (CMS XOR-native backend,
parity makes w = 15 vacuous); appends to data/a17/cover_unsat14.jsonl.

Usage: uv run python scripts/a17_f2a6_cover_unsat_only.py
"""
...
import a17_cover_ladder as ladder
