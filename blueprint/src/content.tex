...
The second condition of \cref{def:nontrivial-logical} is deliberately stronger
than the familiar $g \notin \mathcal{S}$, which it implies by taking $s = g$:
no stabilizer may share the operator part of $g$. With only the weaker
condition a $g$ differing from a stabilizer by a phase would count as acting
