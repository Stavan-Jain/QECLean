/-
# Phase 6: the safe-sector floor for orbit 0 (weight-16 class)

Instantiates the general `floor_of_data` (`MImMembership §14c`) for orbit representative 0,
...
`experiments/bb_lab/scripts/gen_orbit_module.py 0`.
-/
...
namespace Quantum.Stabilizer.Homological.BB.LightStab.O0

set_option maxRecDepth 4096

/-- Orbit-0 (weight-16) `ker ∂₂` representative. -/
def zrep : BaseGroup → ZMod 2 := mkZeta
  [(0,0),(0,1),(0,3),(0,4),(1,0),(1,1),(1,3),(1,4),(3,0),(3,1),(3,3),(3,4),(4,0),(4,1),(4,3),
   (4,4)]
...
/-- **Orbit-0 safe-sector floor**: every base 1-cycle in `[seamC zrep]` has weight `≥ 12`. -/
...
end Quantum.Stabilizer.Homological.BB.LightStab.O0
