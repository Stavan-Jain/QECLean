/-
# Phase 6: the safe-sector floor for orbit 1 (weight-18 class)

Instantiates the general `floor_of_data` (`MImMembership §14c`) for orbit representative 1,
...
`experiments/bb_lab/scripts/gen_orbit_module.py 1`.
-/
...
namespace Quantum.Stabilizer.Homological.BB.LightStab.O1

set_option maxRecDepth 4096

/-- Orbit-1 (weight-18) `ker ∂₂` representative. -/
def zrep : BaseGroup → ZMod 2 := mkZeta
  [(0,0),(0,1),(0,2),(0,5),(1,2),(1,4),(2,1),(2,2),(2,3),(2,4),(3,0),(3,4),(4,0),(4,3),(4,4),
   (4,5),(5,0),(5,2)]
...
/-- **Orbit-1 safe-sector floor**: every base 1-cycle in `[seamC zrep]` has weight `≥ 12`. -/
...
end Quantum.Stabilizer.Homological.BB.LightStab.O1
