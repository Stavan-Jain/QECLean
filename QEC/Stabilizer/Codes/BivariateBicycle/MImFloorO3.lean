/-
# Phase 6: the safe-sector floor for orbit 3 (weight-24 class)

Instantiates the general `floor_of_data` (`MImMembership §14c`) for orbit representative 3,
...
`experiments/bb_lab/scripts/gen_orbit_module.py 3`.
-/
...
namespace Quantum.Stabilizer.Homological.BB.LightStab.O3

set_option maxRecDepth 4096

/-- Orbit-3 (weight-24) `ker ∂₂` representative. -/
def zrep : BaseGroup → ZMod 2 := mkZeta
  [(0,1),(0,2),(0,4),(0,5),(1,0),(1,2),(1,3),(1,5),(2,0),(2,1),(2,3),(2,4),(3,1),(3,2),(3,4),
   (3,5),(4,0),(4,2),(4,3),(4,5),(5,0),(5,1),(5,3),(5,4)]

/-- Side-0 (rightHalf) seam offsets, flat `j*4+s`. -/
def oL : Array Nat := #[0,0,0,0,1,3,1,3,0,0,0,0,1,1,1,1,1,3,1,3]
/-- Side-1 (leftHalf) seam offsets, flat `j*4+s`. -/
def oR : Array Nat := #[0,0,0,0,2,2,2,2,0,0,0,0,3,3,3,3,0,1,0,1]
...
/-- **Orbit-3 safe-sector floor**: every base 1-cycle in `[seamC zrep]` has weight `≥ 12`. -/
...
end Quantum.Stabilizer.Homological.BB.LightStab.O3
