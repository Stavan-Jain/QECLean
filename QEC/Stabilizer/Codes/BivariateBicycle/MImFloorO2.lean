/-
# Phase 6: the safe-sector floor for orbit 2 (weight-18 class)

Instantiates the general `floor_of_data` (`MImMembership §14c`) for orbit representative 2,
...
`experiments/bb_lab/scripts/gen_orbit_module.py 2`.
-/
...
namespace Quantum.Stabilizer.Homological.BB.LightStab.O2

set_option maxRecDepth 4096

/-- Orbit-2 (weight-18) `ker ∂₂` representative. -/
def zrep : BaseGroup → ZMod 2 := mkZeta
  [(0,0),(0,4),(1,1),(1,5),(2,1),(2,2),(2,3),(2,4),(3,0),(3,1),(3,2),(3,5),(4,0),(4,1),(4,2),
   (4,3),(5,0),(5,2)]
...
/-- **Orbit-2 safe-sector floor**: every base 1-cycle in `[seamC zrep]` has weight `≥ 12`. -/
...
end Quantum.Stabilizer.Homological.BB.LightStab.O2
