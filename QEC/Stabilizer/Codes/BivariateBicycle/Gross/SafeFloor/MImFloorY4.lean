...
Generator : experiments/bb_lab/scripts/gen_yrep_module.py (arg: 4)
Regen     : cd experiments/bb_lab && uv run python scripts/gen_yrep_module.py 4
...
`floorOK oL oR = true`.  Generated by `experiments/bb_lab/scripts/gen_yrep_module.py 4`.
-/
