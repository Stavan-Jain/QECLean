...
Generator : experiments/bb_lab/scripts/gen_yrep_module.py (arg: 0)
Regen     : cd experiments/bb_lab && uv run python scripts/gen_yrep_module.py 0
...
`floorOK oL oR = true`.  Generated by `experiments/bb_lab/scripts/gen_yrep_module.py 0`.
-/
